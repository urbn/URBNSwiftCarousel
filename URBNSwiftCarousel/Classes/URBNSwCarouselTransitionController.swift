...
@objc enum TranstionDirection: Int {
    case ScaleUp = 0
    case ScaleDown
}

@objc enum URBNCarouselTransitionState: Int {
    case Start = 0
    case End
}

@objc protocol URBNSwCarouselInteractiveDelegate {
    optional func shouldBeginInteractiveTransitionWithView(view: UIView, direction: TranstionDirection) -> Bool
}

@objc protocol URBNSwCarouselTransitioning {
